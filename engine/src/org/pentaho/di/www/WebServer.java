...
public class WebServer {
  ...
  public void startServer() throws Exception {
    ...
    // 
    /** disable by shawn 2015-5-27
     *  just convient to test
     *  you will have to undisable this sinnpet when you want to resume project 
     */
    ...
    /** disable by shawn 2015-5-27
     *  just convient to test
     *  you will have to undisable this sinnpet you want to resume project 
     */
    /*server.setHandlers( new Handler[] { securityHandler, contexts, resourceHandler, } );*/
    server.setHandlers( new Handler[] { contexts, resourceHandler, } );
