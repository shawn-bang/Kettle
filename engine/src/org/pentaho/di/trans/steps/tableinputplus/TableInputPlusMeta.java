 ...
 *
 */
public class TableInputPlusMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public Object clone() {
	  TableInputPlusMeta retval = (TableInputPlusMeta) super.clone();
    return retval;
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new TableInputPlus( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new TableInputPlusData();
  }
  ...
  public StepIOMetaInterface getStepIOMeta() {
    if ( ioMeta == null ) {
      ...
      StreamInterface stream =
        new Stream(
          StreamType.INFO, null, BaseMessages.getString( PKG, "TableInputPlusMeta.InfoStream.Description" ),
  ...
  @Override
  public TableInputPlusMetaInjection getStepMetaInjectionInterface() {
    return new TableInputPlusMetaInjection( this );
  }
