...
/**
 * This takes care of the external metadata injection into the TableInputPlusMeta class
 *
 * @author Chris
 */
public class TableInputPlusMetaInjection implements StepMetaInjectionInterface {
  ...
  public TableInputPlusMetaInjection( TableInputPlusMeta meta ) {
    this.meta = meta;
  }
  ...
  public TableInputPlusMeta getMeta() {
    return meta;
  }
}
